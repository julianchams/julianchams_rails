...
class PhotographsControllerTest < ActionController::TestCase
  ...
  test "should create photograph" do
    assert_difference('Photograph.count') do
      post :create, photograph: { date: @photograph.date, description: @photograph.description, location: @photograph.location, medium: @photograph.medium, size: @photograph.size, title: @photograph.title, url: @photograph.url }
    end
  ...
  test "should update photograph" do
    put :update, id: @photograph, photograph: { date: @photograph.date, description: @photograph.description, location: @photograph.location, medium: @photograph.medium, size: @photograph.size, title: @photograph.title, url: @photograph.url }
    assert_redirected_to photograph_path(assigns(:photograph))
  end
